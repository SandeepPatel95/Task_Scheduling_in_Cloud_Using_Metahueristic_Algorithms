...
public class HarmonySearchDatacenterBroker extends DatacenterBroker {
    ...
    HarmonySearchDatacenterBroker(String name) throws Exception {
        super(name);
    }
        ...
        for (int i = 0; i < n; i++)
        {
        	...
        	System.out.println("Cost(MakeSpan) of Each Schedule is:");
        	 for(int i = 0; i < HMS; i++)
             {
             	...
             	double makespan = HarmonySearchScheduler.calcMakespan(list5);
        ...
        System.out.println("Worst harmony using Hybrid: " + list4Hyb[worst_Harmony_Hyb]);
    	 ...
    	 for(int it=1;it <= MaxIt;it++)
    		...
    		//Finding Top Five Harmonies
  	       ...
  	       cost_Hyb = HarmonySearchScheduler.calcMakespan(list5);
